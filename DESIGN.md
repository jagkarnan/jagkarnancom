...
This file comes from the [VoltAgent awesome-design-md](https://github.com/VoltAgent/awesome-design-md) collection (`npx getdesign@latest add vercel`). Site tokens in `src/app/globals.css` implement it for this project (light + dark).
