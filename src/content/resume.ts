  ...
  experience: [
    {
      ...
      highlights: [
        ...
        "Prioritise the AI portfolio with leadership — rank use cases by impact, effort, and risk; sequence pilots so early wins fund confidence and budget for the next tranche.",
        "Instil production discipline for AI services — evaluation baselines, logging and monitoring, change control, and cost or latency guardrails so systems stay reliable after go-live.",
        "Align delivery with governance and domain experts — clear data and access boundaries, acceptance criteria, and escalation paths so rollouts stay explainable, auditable, and trusted.",
      ],
